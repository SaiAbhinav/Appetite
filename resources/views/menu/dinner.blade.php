...
<div class="container">      
    <div class="row text-center">
        <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">            
            <h1 style="font-weight:bold;color:#fff;">DINNER</h1>
        </div>
    </div>    
    <div id="myBtnContainer">
        ...
        @foreach($dinners as $dinner)               
            <li class="nav-item">
                <a class="nav-link btn2" onclick="filterSelection('{{ $dinner->category_name }}')">{{ $dinner->category_name }}</a>
            </li>                
        @endforeach
        </ul>
    </div>                 
        ...
        @foreach($items as $item)            
            <div class="filterDiv2 {{ $item->category->category_name }} col-md-4 col-sm-4 col-xs-4 col-lg-4">
                <div class="card" style="margin-top:20px;border:none;">                  
                    <img src="{{ asset('images/dishes/dinner/'.$item->item_name) }}" alt="{{ strtok($item->item_name, ".") }}" data-target="#{{ strtok($item->item_name, ".") }}Model" data-toggle="modal" style="min-height: 100px;max-height:200px;width:auto;border-top-left-radius: 5px;border-top-right-radius: 5px;" class="img-fluid">
                    <div class="row">                        
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6 text-center">
                                            <img src="{{ asset('images/dishes/lunch/'.$item->item_name) }}" alt="{{ $item->item_name }}" data-target="#{{ strtok($item->item_name, ".") }}Model" data-toggle="modal" style="min-height: 150px;max-height:250px;border-radius:10px;" class="img-fluid">
                                        </div>
